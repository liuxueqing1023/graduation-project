...
class UiMainWindow():
    def Ui_setup(self, MainWindow):
        MainWindow.setObjectName("PersonalWindow")

        #设置主窗口尺寸
        MainWindow.resize(400, 650)
        MainWindow.setWindowTitle('个人信息修改')
    ...
    def add_Label(self, MainWindow):
        ...
        # 注销，修改密码
        self.label1 = QtWidgets.QLabel('<style> a {text-decoration: none; color: #999999} </style><a href = "#">用户注销</a>')
        self.label2 = QtWidgets.QLabel('<style> a {text-decoration: none; color: #999999} </style><a href = "#">密码修改</a>')
